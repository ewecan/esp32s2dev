...
void displayMenuSelect_UPCLK(void)
{
	...
	TFT_Display_Image_Select(CS4_PIN, pic_systemTheme_SetUPCLK);
	TFT_Display_Image_Select(CS3_PIN, pic_systemTheme_UPCLK);
}
/**
 * @brief 欢迎界面 按键操作
 * @param  key  按键键码
...
void displayMenuSelect_UPCLK_KEY(int8_t key)
{
	...
	case 2: //按键2  下
	{
		...
		TFT_Display_Image_Select(CS2_PIN, pic_systemTheme_UPCLK);
		TFT_Display_Image(CS3_PIN, CS4_PIN, pic_systemTheme_SetUPCLK);
